...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @return \Miniplayer\Domain\User|throws an exception if no matching user is found
     */
    ...
    {
        return 'Miniplayer\Domain\User' === $class;
    }
     ...
     *
     * @param \Miniplayer\Domain\User $user The user to save
     */
